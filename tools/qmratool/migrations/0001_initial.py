# Generated by Django 3.1.1 on 2020-09-28 09:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exposure', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='qmratool.exposure')),
                ('source', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, to='qmratool.sourcewater')),
                ('treatment', models.ManyToManyField(blank=True, related_name='treatment', to='qmratool.Treatment')),
            ],
        ),
        migrations.CreateModel(
            name='LogRemoval',
